...
@app.route("/ratings/<userid>", methods=["GET"]) # return all ratings for an specific user
...
@app.route("/ratings/movies/<movieid>", methods=["GET"]) # return all ratings for an specific movie
